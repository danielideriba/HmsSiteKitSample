...
class CheckboxCountriesSpinner(useCountryListSwitch: Switch, countryListTextView: TextView, countryList: List<String>) {
    ...
    private class LocationTypeItemArrayAdapter(context: Context?, placeFields: List<CountryListItem>?) : ArrayAdapter<CountryListItem?>(context!!, android.R.layout.simple_list_item_multiple_choice, placeFields!!),
