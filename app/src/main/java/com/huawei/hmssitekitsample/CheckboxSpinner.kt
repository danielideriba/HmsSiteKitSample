...
class CheckboxSpinner(usePOITypeSwitch: Switch, poiTypeTextView: TextView, poiTypeList: List<LocationType>) {
    ...
    private class LocationTypeItemArrayAdapter(context: Context?, placeFields: List<LocationTypeItem>?) : ArrayAdapter<LocationTypeItem?>(context!!, android.R.layout.simple_list_item_multiple_choice, placeFields!!),
